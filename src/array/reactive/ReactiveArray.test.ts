...
import ReactiveArray, { reactiveArray } from './ReactiveArray.js';
...
describe('ReactiveArray', () => {
  ...
  it('should throw when items is not an array', () => {
    expect(() => reactiveArray(0 as unknown as Array<number>, () => 0)).toThrow(
      `[Utils:ReactiveArray] expected Array but got number`
    );
  });
